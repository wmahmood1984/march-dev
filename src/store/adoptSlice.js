...
export const MonthlyApproval = createAsyncThunk("MonthlyApproval",
    async ({Maddress,MstackValue , StakingToken,sender})=>{
        try {
            var conString = MstackValue.toString()
   ...
   //         const result = await StakingToken.methods.approve(Maddress,value).send({from : sender})
            const result = await StakingToken.methods.approve(Maddress,web3.utils.toWei(conString,"ether")).send({from : sender})
            return result;
...
export const WeeklyApproval = createAsyncThunk("WeeklyApproval",
    async ({Waddress,WstackValue , StakingToken,sender})=>{
        try {
            var conString = WstackValue.toString()
...
//            console.log("from server",StakingToken)
            ...
            const result = await StakingToken.methods.approve(Waddress,web3.utils.toWei(conString,"ether")).send({from : sender})
            return result;
...
//            const result = await YOLOYearly.methods.stake(stackValue).send({from : sender})
            const result = await YOLOYearly.methods.stake(web3.utils.toWei(conString,"ether")).send({from : sender})
            return result;
...
export const MonthlyStaking = createAsyncThunk("MonthlyStaking",
    async ({MstackValue,YOLOMonthly,sender})=>{
        try {
            var conString = MstackValue.toString()
//            var value = new BigNumber(MstackValue*1000000000000000000)
            const result = await YOLOMonthly.methods.stake(web3.utils.toWei(conString,"ether")).send({from : sender})
            return result;
...
export const WeeklyStaking = createAsyncThunk("WeeklyStaking",
    async ({WstackValue,YOLOWeekly,sender})=>{
        try {
            var conString = WstackValue.toString()
//            var value = new BigNumber(WstackValue*1000000000000000000)
            const result = await YOLOWeekly.methods.stake(web3.utils.toWei(conString,"ether")).send({from : sender})
            return result;
...
export const YearlyWithdraw = createAsyncThunk("YearlyWithdraw",
    async ({stackValue,YOLOYearly,sender})=>{
        try {
            var conString = stackValue.toString()
//            var value = new BigNumber(stackValue*1000000000000000000)
            const result = await YOLOYearly.methods.withdraw(web3.utils.toWei(conString,"ether")).send({from : sender})
            return result;
...
export const MonthlyWithdraw = createAsyncThunk("YearlyWithdraw",
    async ({MstackValue,YOLOMonthly,sender})=>{
        try {
            var conString = MstackValue.toString()
 //           var value = new BigNumber(MstackValue*1000000000000000000)
            const result = await YOLOMonthly.methods.withdraw(web3.utils.toWei(conString,"ether")).send({from : sender})
            return result;
...
export const WeeklyWithdraw = createAsyncThunk("YearlyWithdraw",
    async ({WstackValue,YOLOWeekly,sender})=>{
        try {
            var conString = WstackValue.toString()
//            var value = new BigNumber(WstackValue*1000000000000000000)
            const result = await YOLOWeekly.methods.withdraw(web3.utils.toWei(conString,"ether")).send({from : sender})
            return result;
